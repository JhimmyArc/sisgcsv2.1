...
CREATE TABLE IF NOT EXISTS `sgcsatatasignartarea` (
  ...
  KEY `FK_sgcsatatasignartarea_sgcspentproyectoentregable` (`ENTid`),
  CONSTRAINT `FK_sgcsatatasignartarea_sgcspentproyectoentregable` FOREIGN KEY (`ENTid`) REFERENCES `sgcspentproyectoentregable` (`ENTid`),
...
INSERT INTO `sgcsatatasignartarea` (`ATAid`, `ENTid`, `PEQid`, `ATAresponsable`, `ATAnombre`, `ATAdescripcion`, `ATAprogreso`, `ATAfechaInicio`, `ATAfechaFin`, `ATAestado`) VALUES
	(1, 1, NULL, 3, 'Tarea1', '---', 0, '2017-06-06', '2017-06-12', 'C');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC;
